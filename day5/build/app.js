...
let episodeList = document.querySelector("ul.episodes");
let shiftOn = false;
...
function renderEpisodes() {
    ...
    <label for="episode-${episode.id}">
      <input type="checkbox" ${episode.selected ? "checked" : ""} id="episode-${episode.id}" onClick="handleCheckboxClick(event, ${episode.id})" />
